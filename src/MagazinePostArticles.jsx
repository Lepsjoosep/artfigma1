    ...
    <>
      <div className='flex flex-row justify-center pt-20 pl-10 pr-10'>
          <div className='border-1 p-10'>
            ...
            <img src="./src/Pictures/Hopedieslast.jpg" alt="" className='h-100 w-130 object-cover object-[70%_center]'/>
            <h1 className='font-bold text-3xl w-100 h-15 mt-5'>Hope dies last</h1>
          ...
          <div className='border-1 p-10'>
            ...
            <img src="./src/Pictures/art.jpg" alt="" className='h-100 w-130 object-cover object-[60%_center]'/>
...
export default MagazinePostArticles;